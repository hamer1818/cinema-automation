...
class Sinema():
    ...
    def anaPencere(self):
        ...
        self.pencere.configure(background="black")
        ...
        self.filmButon1 = tk.Button(self.pencere,image=self.filmButon1resim,width=160,height=300,foreground="black",bg="red",command=self.film1)
        self.filmButon1.place(x=100,y=0)
        self.film1Baslik = tk.Label(self.pencere,text=self.film1dbAdi,font=("Arial",12,"bold"),height=2,background="black",foreground="white",width=16)
        self.film1Baslik.place(x=100,y=270)
        self.film1DetayButon = tk.Button(self.pencere,text="Detay",background="white",foreground="black",width=5,height=2,command=self.film1Detay)
        self.film1DetayButon.place(x=100,y=3)
        
        self.filmButon2 = tk.Button(self.pencere,image=self.filmButon2resim,width=160,height=300,foreground="black",bg="red",command=self.film2)
        self.filmButon2.place(x=300,y=0)
        self.film2Baslik = tk.Label(self.pencere,text=self.film2dbAdi,font=("Arial",12,"bold"),height=2,background="black",foreground="white",width=16)
        self.film2Baslik.place(x=300,y=270)
        self.film2DetayButon = tk.Button(self.pencere,text="Detay",background="white",foreground="black",width=5,height=2,command=self.film2Detay)
        self.film2DetayButon.place(x=300,y=3)

        self.filmButon3 = tk.Button(self.pencere,image=self.filmButon3resim,width=160,height=300,foreground="black",bg="red",command=self.film3)
        self.filmButon3.place(x=500,y=0)
        self.film3Baslik = tk.Label(self.pencere,text=self.film3dbAdi,font=("Arial",12,"bold"),height=2,background="black",foreground="white",width=16)
        self.film3Baslik.place(x=500,y=270)
        self.film3DetayButon = tk.Button(self.pencere,text="Detay",background="white",foreground="black",width=5,height=2,command=self.film3Detay)
        self.film3DetayButon.place(x=500,y=3)

        self.filmButon4 = tk.Button(self.pencere,image=self.filmButon4resim,width=160,height=300,foreground="black",bg="red",command=self.film4)
        self.filmButon4.place(x=100,y=350)
        self.film4Baslik = tk.Label(self.pencere,text=self.film4dbAdi,font=("Arial",12,"bold"),height=2,background="black",foreground="white",width=16)
        self.film4Baslik.place(x=100,y=620)
        self.film4DetayButon = tk.Button(self.pencere,text="Detay",background="white",foreground="black",width=5,height=2,command=self.film4Detay)
        self.film4DetayButon.place(x=100,y=353)

        self.filmButon5 = tk.Button(self.pencere,image=self.filmButon5resim,width=160,height=300,foreground="black",bg="red",command=self.film5)
        self.filmButon5.place(x=300,y=350)
        self.film5Baslik = tk.Label(self.pencere,text=self.film5dbAdi,font=("Arial",12,"bold"),height=2,background="black",foreground="white",width=16)
        self.film5Baslik.place(x=300,y=620)
        self.film5DetayButon = tk.Button(self.pencere,text="Detay",background="white",foreground="black",width=5,height=2,command=self.film5Detay)
        self.film5DetayButon.place(x=300,y=353)

        self.filmButon6 = tk.Button(self.pencere,image=self.filmButon6resim,width=160,height=300,foreground="black",bg="red",command=self.film6)
        self.filmButon6.place(x=500,y=350)
        self.film6Baslik = tk.Label(self.pencere,text=self.film6dbAdi,font=("Arial",12,"bold"),height=2,background="black",foreground="white",width=16)
        self.film6Baslik.place(x=500,y=620)
        self.film6DetayButon = tk.Button(self.pencere,text="Detay",background="white",foreground="black",width=5,height=2,command=self.film6Detay)
    ...
    def film1Detay(self):
        ...
        # self.film1DetayPencere.configure(background="black")
        ...
        self.film1DetayLabel.configure(background="black")
    ...
    def film2Detay(self):
        ...
        self.film2DetayLabel.configure(background="black")
    ...
    def film3Detay(self):
        ...
        self.film3DetayLabel.configure(background="black")
    ...
    def film4Detay(self):
        ...
        self.film4DetayLabel.configure(background="black")
    ...
    def film5Detay(self):
        ...
        self.film5DetayLabel.configure(background="black")
    ...
    def film6Detay(self):
        ...
        self.film6DetayLabel.configure(background="black")
    ...
    def film1(self):
        ...
        self.film1Pencere.configure(bg="black")
        ...
        for i,koltukIsım in enumerate(self.filmBirKoltuk):
            for j in range(1,11):
                self.koltukButton = tk.Button(self.film1Pencere, text=f"{koltukIsım} {j}",bg="red",width=5,height=2,command=lambda selftext=f"{koltukIsım}{j}":self.koltuksecmebutonlari(selftext,self.film1Pencere,self.koltukNumaraları1))
                self.koltukButton.grid(row=i, column=j, pady=5)
        

        self.perde = tk.Label(self.film1Pencere, text="PERDE",bg="white",fg="black",width=60,height=2)
        self.perde.grid(row=9, column=0, columnspan=11, pady=10)
        # kapatma butonu
        self.kapatmaButon = tk.Button(self.film1Pencere, text="Kapat",bg="red",width=10,height=2,command=self.film1Pencere.destroy)
        self.kapatmaButon.grid(row=10, column=0, columnspan=5, pady=10)
        # print(self.film1dbAdi)
        self.koltuklariSilmeButon = tk.Button(self.film1Pencere, text="Koltukları Sil",bg="red",height=2,command=lambda :self.koltukSil(self.film1dbAdi))
        self.koltuklariSilmeButon.grid(row=10, column=5, columnspan=6, pady=10)

        self.film1TurLabel = tk.Label(self.film1Pencere, text=f"Tür: {self.film1tur}",bg="red",fg="white",height=2)
    ...
    def film2(self):
        ...
        self.film2Pencere.configure(bg="black")
        ...
        for i,koltukIsım in enumerate(self.filmIkiKoltuk):
            for j in range(1,9):
                self.koltukButton = tk.Button(self.film2Pencere, text=f"{koltukIsım} {j}",bg="red",width=5,height=2,command=lambda selftext=f"{koltukIsım}{j}":self.koltuksecmebutonlari(selftext,self.film2Pencere,self.koltukNumaraları2))
                self.koltukButton.grid(row=i, column=j,  pady=5)
        self.perde = tk.Label(self.film2Pencere, text="PERDE",bg="white",fg="black",width=60,height=2)
        self.perde.grid(row=5, column=0, columnspan=11, pady=10)
        # kapatma butonu
        self.kapatmaButon = tk.Button(self.film2Pencere, text="Kapat",bg="red",width=10,height=2,command=self.film2Pencere.destroy)
        self.kapatmaButon.grid(row=10, column=0, columnspan=5, pady=10)
        # print(self.film1dbAdi)
        self.koltuklariSilmeButon = tk.Button(self.film2Pencere, text="Koltukları Sil",bg="red",width=10,height=2,command=lambda :self.koltukSil(self.film2dbAdi))
        self.koltuklariSilmeButon.grid(row=10, column=5, columnspan=6, pady=10)

        self.film2TurLabel = tk.Label(self.film2Pencere, text=f"Tür: {self.film2tur}",bg="red",fg="white",height=2)
    ...
    def film3(self):
        ...
        self.film3Pencere.configure(bg="black")
        ...
        for i,koltukIsım in enumerate(self.filmUcKoltuk):
            for j in range(1,11):
                self.koltukButton = tk.Button(self.film3Pencere, text=f"{koltukIsım} {j}",bg="red",width=5,height=2,command=lambda selftext=f"{koltukIsım}{j}":self.koltuksecmebutonlari(selftext,self.film3Pencere,self.koltukNumaraları3))
                self.koltukButton.grid(row=i, column=j,  pady=5)
        self.perde = tk.Label(self.film3Pencere, text="PERDE",bg="white",fg="black",width=60,height=2)
        self.perde.grid(row=5, column=0, columnspan=11, pady=10)
        # kapatma butonu
        self.kapatmaButon = tk.Button(self.film3Pencere, text="Kapat",bg="red",width=10,height=2,command=self.film3Pencere.destroy)
        self.kapatmaButon.grid(row=10, column=0, columnspan=5, pady=10)
        # print(self.film1dbAdi)
        self.koltuklariSilmeButon = tk.Button(self.film3Pencere, text="Koltukları Sil",bg="red",width=10,height=2,command=lambda :self.koltukSil(self.film3dbAdi))
        self.koltuklariSilmeButon.grid(row=10, column=5, columnspan=6, pady=10)

        self.film3TurLabel = tk.Label(self.film3Pencere, text=f"Tür: {self.film3tur}",bg="red",fg="white",height=2)
    ...
    def film4(self):
        ...
        self.film4Pencere.configure(bg="black")
        ...
        for i,koltukIsım in enumerate(self.filmDortKoltuk):
            for j in range(1,11):
                self.koltukButton = tk.Button(self.film4Pencere, text=f"{koltukIsım} {j}",bg="red",width=5,height=2,command=lambda selftext=f"{koltukIsım}{j}":self.koltuksecmebutonlari(selftext,self.film4Pencere,self.koltukNumaraları4))
                self.koltukButton.grid(row=i, column=j,  pady=5)

        self.perde = tk.Label(self.film4Pencere, text="PERDE",bg="white",fg="black",width=60,height=2)
        self.perde.grid(row=5, column=0, columnspan=11, pady=10)
        # kapatma butonu
        self.kapatmaButon = tk.Button(self.film4Pencere, text="Kapat",bg="red",width=10,height=2,command=self.film4Pencere.destroy)
        self.kapatmaButon.grid(row=10, column=0, columnspan=5, pady=10)
        # print(self.film1dbAdi)
        self.koltuklariSilmeButon = tk.Button(self.film4Pencere, text="Koltukları Sil",bg="red",width=10,height=2,command=lambda :self.koltukSil(self.film4dbAdi))
        self.koltuklariSilmeButon.grid(row=10, column=5, columnspan=6, pady=10)

        self.film4TurLabel = tk.Label(self.film4Pencere, text=f"Tür: {self.film4tur}",bg="red",fg="white",height=2)
    ...
    def film5(self):
        ...
        self.film5Pencere.configure(bg="black")
        ...
        for i,koltukIsım in enumerate(self.filmBesKoltuk):
            for j in range(1,11):
                self.koltukButton = tk.Button(self.film5Pencere, text=f"{koltukIsım} {j}",bg="red",width=5,height=2,command=lambda selftext=f"{koltukIsım}{j}":self.koltuksecmebutonlari(selftext,self.film5Pencere,self.koltukNumaraları5))
                self.koltukButton.grid(row=i, column=j,  pady=5)
        self.perde = tk.Label(self.film5Pencere, text="PERDE",bg="white",fg="black",width=60,height=2)
        self.perde.grid(row=5, column=0, columnspan=11, pady=10)
        # kapatma butonu
        self.kapatmaButon = tk.Button(self.film5Pencere, text="Kapat",bg="red",width=10,height=2,command=self.film5Pencere.destroy)
        self.kapatmaButon.grid(row=10, column=0, columnspan=5, pady=10)
        # print(self.film1dbAdi)
        self.koltuklariSilmeButon = tk.Button(self.film5Pencere, text="Koltukları Sil",bg="red",width=10,height=2,command=lambda :self.koltukSil(self.film5dbAdi))
        self.koltuklariSilmeButon.grid(row=10, column=5, columnspan=6, pady=10)

        self.film5TurLabel = tk.Label(self.film5Pencere, text=f"Tür: {self.film5tur}",bg="red",fg="white",height=2)
    ...
    def film6(self):
        ...
        self.film6Pencere.configure(bg="black")
        ...
        for i,koltukIsım in enumerate(self.filmAltiKoltuk):
            for j in range(1,11):
                self.koltukButton = tk.Button(self.film6Pencere, text=f"{koltukIsım} {j}",bg="red",width=5,height=2,command=lambda selftext=f"{koltukIsım}{j}":self.koltuksecmebutonlari(selftext,self.film6Pencere,self.koltukNumaraları6))
                self.koltukButton.grid(row=i, column=j, pady=5)
        self.perde = tk.Label(self.film6Pencere, text="PERDE",bg="white",fg="black",width=60,height=2)
        self.perde.grid(row=5, column=0, columnspan=11, pady=10)
        # kapatma butonu
        self.kapatmaButon = tk.Button(self.film6Pencere, text="Kapat",bg="red",width=10,height=2,command=self.film6Pencere.destroy)
        self.kapatmaButon.grid(row=10, column=0, columnspan=5, pady=10)
        # print(self.film1dbAdi)
        self.koltuklariSilmeButon = tk.Button(self.film6Pencere, text="Koltukları Sil",bg="red",width=10,height=2,command=lambda :self.koltukSil(self.film6dbAdi))
        self.koltuklariSilmeButon.grid(row=10, column=5, columnspan=6, pady=10)

        self.film6TurLabel = tk.Label(self.film6Pencere, text=f"Tür: {self.film6tur}",bg="red",fg="white",height=2)
    ...
    def koltuksecmebutonlari(self,butonİsim,hangiPencere,koltuklar):
        self.secilenKoltukEtiket = tk.Label(hangiPencere, text="Seçilen Koltuklar:",font="Arial,20,'bold','underline'",bg="red",fg="white",width=23,height=2)
        self.secilenKoltukEtiket.place(x=500,y=250)
        self.secilmisKoltuk = tk.Label(hangiPencere, text="",bg="red",fg="white",width=30,height=2)
        ...
        if butonİsim in koltuklar:
            ...
            self.secilmisKoltuk.config(bg="red")
            ...
            self.secilmisKoltuk.config(text=", ".join(koltuklar))
            self.secilmisKoltuk.config(bg="red")
        self.butonSeçildi1 = tk.Button(hangiPencere, text="Seçimi Tamamla",bg="red",fg="white",width=20,height=2,command=lambda:self.seçimiTamamla(hangiPencere,koltuklar))
        self.butonSeçildi1.place(x=500,y=350)
        self.koltukYazdir = tk.Label(hangiPencere, text="Seçilen Koltuklar:",font="Arial,20,'bold','underline'",bg="black",fg="white",width=23,height=2)
    ...
    def tanıtım(self):
        ...
        self.tanıtımPencere.configure(background="red")
